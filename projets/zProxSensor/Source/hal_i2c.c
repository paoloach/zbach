 ...
 *                                             CONSTANTS
 ***************************************************************************************************/
#define ISQC_SCL P1_4
#define ISQC_SDA P1_5
...
#define ISQC_SET_INPUT_PIN() do {P1DIR = 0x00;} while (0)  //p1_4 + p1_5
#define ISQC_SET_OUTPUT_PIN() do {P1DIR = 0x30;} while (0)  //p1_4 + p1_5
#define ISQC_SET_SCL_OUT() do {P1DIR |= 0x10;} while (0)  //p1_4
#define ISQC_SET_SDA_OUT() do {P1DIR |= 0x20;} while (0)  //p1_5
#define ISQC_SET_SCL_IN() do {P1DIR &= ~(0x10);} while (0)  //p1_4
#define ISQC_SET_SDA_IN() do {P1DIR &= ~(0x20);} while (0)  //p1_5
